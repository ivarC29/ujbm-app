...
@Component({
    ...
    template: ` <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            ...
            <img src="logo.png" alt="Company Logo" class="layout-topbar-logo-image" />
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <div class="user-profile-menu">
                        <span class="username-text hidden lg:block">{{ username }}</span>
                        <button type="button" class="layout-topbar-action p-button-text flex align-items-center" (click)="menu.toggle($event)">
                            <i class="pi pi-user mr-2"></i>
                            <span class="username-text">{{ username }}</span>
                        </button>
                        <p-menu #menu [model]="profileMenuItems" [popup]="true" appendTo="body"></p-menu>
                    </div>
                </div>
            </div>
        </div>
